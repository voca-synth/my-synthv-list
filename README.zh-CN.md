...
在线收听：**[https://voca-synth.github.io/my-synthv-list/](https://voca-synth.github.io/my-synthv-list/)**，也可以[做一份你自己的歌单](#做一份你自己的歌单)。
...
上线后欢迎分享。在本仓库提交一个附上链接的 issue，让更多人看到；也可以把页面发给你收录的创作者，他们通常会很高兴知道有人喜欢自己的作品。对网站本身的改进，欢迎提交 pull request。发布之前请先阅读[免责声明](#免责声明)：你对自己歌单中分享的内容负责。
...
第 07 首的上传者标注了内容警告，观看前请先阅读视频说明。第 04 首已被上传者设为不公开列出，可以从本歌单播放，但在 YouTube 搜索中找不到。署名信息取自 2026 年 9 月的视频说明和原始上传，视频随时可能被删除或设为私享。如果你是创作者，希望把作品从歌单中移除，请提交 issue 或发送邮件至 `scuba-had-goofy[at]duck.com`。

其他人使用本项目制作的歌单归其作者所有。我们不审核、不托管、也不认可这些歌单，对其内容不承担任何责任，包括在本仓库的 issue 中分享的链接。如果你制作歌单，请自行判断并确认所分享的内容：视频是官方或经授权的上传，署名信息准确，必要的内容警告已标注，页面遵守 YouTube 的服务条款和你所在地区的法律。代码按许可证所述"按原样"提供，不附带任何形式的担保。

## 许可证

Copyright © 2026 Voca Synth（[github.com/didvc](https://github.com/didvc)）。本站代码采用 [GNU AGPL-3.0](LICENSE) 许可证（SPDX：`AGPL-3.0-only`）。该许可证不适用于文中列出的歌曲、视频和插画。许可证范围、第三方服务和商标说明见 [NOTICE](NOTICE)。

联系方式：提交 issue，或发送邮件至 `scuba-had-goofy[at]duck.com`。
